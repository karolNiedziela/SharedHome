...
{
    internal class GetInvitationByIdHandler : IRequestHandler<GetInvitationById, ApiResponse<InvitationDto>>
    {
        ...
        public async Task<ApiResponse<InvitationDto>> Handle(GetInvitationById request, CancellationToken cancellationToken)
        {
