...
namespace SharedHome.Application.UnitTests.ShoppingLists
{
    public class ChangeOfPriceProductHandlerTests
    {
        ...
        public ChangeOfPriceProductHandlerTests()
        {
            ...
            _commandHandler = new ChangePriceOfProductHandler(_shoppingListRepository);
        }

        [Fact]
        public async Task Handle_Should_Call_Repository_OnSuccess()
        {
            var command = new ChangePriceOfProduct(1, "Product", 25);
            ...
            await _shoppingListRepository.Received(1).UpdateAsync(Arg.Is<ShoppingList>(shoppingList =>
                shoppingList.Products.First().Price == 25));
        }
    }
}
